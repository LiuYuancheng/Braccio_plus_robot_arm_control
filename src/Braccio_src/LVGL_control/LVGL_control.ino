...
// LVGL lib offical document: https://docs.lvgl.io/master/overview/event.html#event-codes
...
void customMenu(){
  ...
  //initializes the style variable
  ...
  // guarantees that only one button can be selected at a time when its second parameter is true.
  lv_btnmatrix_set_one_checked(btnm, true);

  //sets up all the button matrix events to the eventHandler() function, in this case LV_EVENT_ALL is used to receive all the events.
